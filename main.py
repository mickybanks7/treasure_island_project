...
step1 = input('You\'re at a crossroad. Where do you want to go? left or right?? \n')
if (step1 == "left") or (step1 == "Left") or (step1 == "LEFT"):
  print("swim or wait")
  ...
  if (step2 == "wait") or (step2 == "Wait") or (step2 == "WAIT"):
    print("which door")
    ...
    if (step3 == "Red") or (step3 == "red") or (step3 == "RED"):
      print("Burned by fire. Game Over")
    elif (step3 == "blue") or (step3 == "Blue") or (step3 == "BLUE"):
      print("Eaten by beasts. Game Over")
    elif (step3 == "yellow") or (step3 == "Yellow") or ("YELLOW"):
      print("You Win")
    else:
      print("Game Over")
  else:
